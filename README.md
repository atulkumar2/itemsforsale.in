...
- Run all E2E scripts (auto-discovers `scripts/e2e/flows/*-flow.mjs`): `npm run test:e2e`
- Run one E2E flow directly: `node scripts/e2e/flows/<name>-flow.mjs`
- Run lint: `npm run lint`

E2E run behavior:

- `npm run test:e2e` uses `scripts/e2e/run-all.mjs`
- runner discovers all `*-flow.mjs` files inside `scripts/e2e/flows/`
